...
\section{Server}
The Meeting Scheduler application is structured using server-client model.
Server is responsible for providing the clients with results for their requests, more specifically meeting point based on input received. To achieve that, server should be having dataset available 
